...
type VirtualboxBootstrapper struct{}

func (b *VirtualboxBootstrapper) Bootstrap(params BootstrapParams) (*types.RawImage, error) {
...
func (b *VirtualboxBootstrapper) UseEc2() bool {
	return false
}
