...
To learn more about the motivation behind project UniK, read our [blog](https://github.com/emc-advanced-dev/unik/wiki/UniK:-Build-and-Run-Unikernels-with-Ease) post, or [watch](https://youtu.be/qtknmR_XnUE) session ([Slides](http://www.slideshare.net/IditLevine/unik-slides)).
