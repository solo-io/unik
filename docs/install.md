...
#### Prerequisites:
- [Docker](http://www.docker.com/) installed and running **Note: *Docker for Mac* will not work as it does not support Linux's device mapper. Until we find an alternative for building disk images, if you are running Unik on OS X, you will need to use `docker-machine` (part of the Docker Toolbox for Mac).**
